export default function Card1({ icon, title, description, hoverShadow }) {
  return (
    <div
      className={`w-full md:flex-1 bg-brand-background rounded-2xl relative min-w-[260px] max-w-sm md:w-auto flex flex-col items-center border border-brand-line transition-transform duration-200 hover:-translate-y-2 ${hoverShadow}`}
    >
