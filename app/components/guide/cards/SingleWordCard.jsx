...
export default function SingleWordCard({ leftText, symbol, rightText }) {
  return (
    <div className="bg-brand-background rounded-2xl border-2 border-brand-line flex flex-col items-center justify-center w-full max-w-[1080px] min-h-[301px] py-[60px] relative">
